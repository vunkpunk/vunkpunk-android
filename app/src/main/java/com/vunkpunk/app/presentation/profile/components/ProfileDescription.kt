...
fun ProfileDescription() {
    ...
    Column(modifier = Modifier
        ...
        Row(modifier = Modifier
            ...
            Text(text = "21 общежитие", fontSize = 20.sp)
        }
        Row(modifier = Modifier
            .fillMaxWidth()
            .height(40.dp)
            ...
            Image(modifier = Modifier
                ...
                contentDescription = null)
            Text(text = "Матмех", fontSize = 20.sp)
        }
        Row(modifier = Modifier
            .fillMaxWidth()
            .height(40.dp)
            ...
            Image(modifier = Modifier
                ...
                contentDescription = null)
            Text(text = "@iraedeus", fontSize = 20.sp)
        }
        Column(modifier = Modifier
            .fillMaxWidth()
            .wrapContentHeight(),) {
            Row(modifier = Modifier
                ...
                .height(30.dp),
                verticalAlignment = Alignment.CenterVertically) {
                Text(text = "О себе:", fontSize = 20.sp)
            }
            }
            Text(text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." +
                    ...
                    " Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id es", fontSize = 16.sp)
